...
public class MemoryUsage {
    ...
    private static void getMemoryOverview(String place) {
        System.out.println("-----Speicher�bersicht(" + place + ")------");
        ...
        System.out.println("Verf�gbare Prozessoren: " + r.availableProcessors());
    }
    ...
    /**
     * Berechnet den tatsaechlich noch verf�gbaren Heap-Speicher
     */
